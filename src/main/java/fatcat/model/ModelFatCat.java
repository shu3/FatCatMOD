...
public class ModelFatCat extends ModelBase {
    ...
    public ModelFatCat()
    {
    	...
    	frontRightLeg.setRotationPoint(-4F, 20F, -4F);
    	...
    	backLeftLeg.setRotationPoint(4F, 20F, 6F);
    	...
    	ripRight.setRotationPoint(0F, HEAD_POS_Y, -5F);
    	...
    	mouth.setRotationPoint(0F, HEAD_POS_Y, -5F);
