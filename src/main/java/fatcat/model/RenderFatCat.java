...
public class RenderFatCat extends RendererLivingEntity
{
    ...
    private void renderLeash(EntityLiving cat, double x, double y, double z, float p_110827_9_)
    {
        ...
        if (entity != null)
        {
            ...
            for (i = 0; i <= 24; ++i)
            {
                ...
                {
                    // setColorRGBA_F
                    renderer.setColorRGBA_F(0.5F, 0.4F, 0.3F, 1.0F);
                }
                else
                {
                    // setColorRGBA_F
                    renderer.setColorRGBA_F(0.35F, 0.28F, 0.21000001F, 1.0F);
                }
                f2 = (float) i / 24.0F;
    ...
    public void doRender(Entity cat, double x, double y, double z, float p_76986_8_, float p_76986_9_)
    {
        ...
        // down leash
        renderLeash((EntityFatCat) cat, x, y - 0.4D, z, p_76986_9_);
    }
