...
class GuiStatus extends GuiContainer
{
    ...
    GuiStatus(EntityPlayer player, EntityFatCat cat)
    {
    ...
    protected void drawGuiContainerBackgroundLayer(float p_146976_1_, int mouseX, int mouseY)
    {
        ...
        // health
        drawIconBar(cat.getHealth(), cat.getMaxHealth(), 5, guiLeft + 70, guiTop + 46, xSize, 8, xSize + 8, 8);
        // hunger
        drawIconBar(cat.getHunger(), EntityFatCat.HUNGER_MAX, 5, guiLeft + 130, guiTop + 46, xSize, 2 * 8, xSize + 8, 2 * 8);
        // bladder
        drawIconBar(cat.getBladder(), EntityFatCat.BLADDER_MAX, 5, guiLeft + 70, guiTop + 68, xSize, 0, xSize + 8, 0);
        // tiredness
        ...
        // love
        drawIconBar(cat.getLove(), EntityFatCat.LOVE_MAX, 5, guiLeft + 130, guiTop + 90, xSize, 8 * 6, xSize + 8, 8 * 6);
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        ...
        this.fontRendererObj.drawString(I18n.format("fatcat.gui.status.love"), 130, 78, 0x404040);
    }
